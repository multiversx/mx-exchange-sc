...
use farm_staking_locked::claim_only_boosted_staking_rewards::ClaimOnlyBoostedStakingRewardsModule;
use farm_staking_locked::compound_stake_farm_rewards::CompoundStakeFarmRewardsModule;
...
use farm_staking_locked::claim_stake_farm_rewards::ClaimStakeFarmRewardsModule;
use farm_staking_locked::custom_rewards::CustomRewardsModule;
use farm_staking_locked::stake_farm::StakeFarmModule;
use farm_staking_locked::token_attributes::{StakingFarmTokenAttributes, UnbondSftAttributes};
use farm_staking_locked::unbond_farm::UnbondFarmModule;
use farm_staking_locked::unstake_farm::UnstakeFarmModule;
use farm_staking_locked::*;
...
where
    FarmObjBuilder: 'static + Copy + Fn() -> farm_staking_locked::ContractObj<DebugApi>,
    ...
    PermissionsHubObjBuilder: 'static + Copy + Fn() -> permissions_hub::ContractObj<DebugApi>,
{
    ...
    pub farm_wrapper:
        ContractObjWrapper<farm_staking_locked::ContractObj<DebugApi>, FarmObjBuilder>,
