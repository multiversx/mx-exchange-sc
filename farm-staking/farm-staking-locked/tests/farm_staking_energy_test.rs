...
#[test]
fn farm_staking_locked_with_energy_setup_test() {
    let mut fs_setup = FarmStakingSetup::new(
        farm_staking_locked::contract_obj,
...
#[test]
fn farm_staking_locked_boosted_rewards_no_energy_test() {
    DebugApi::dummy();
    let mut fs_setup = FarmStakingSetup::new(
        farm_staking_locked::contract_obj,
        energy_factory::contract_obj,
...
#[test]
fn farm_staking_locked_other_user_enter_negative_test() {
    DebugApi::dummy();
    let mut fs_setup = FarmStakingSetup::new(
        farm_staking_locked::contract_obj,
        energy_factory::contract_obj,
...
#[test]
fn farm_staking_locked_boosted_rewards_with_energy_test() {
    DebugApi::dummy();
    let mut fs_setup = FarmStakingSetup::new(
        farm_staking_locked::contract_obj,
        energy_factory::contract_obj,
...
#[test]
fn farm_staking_locked_partial_position_handling_test() {
    DebugApi::dummy();
    let mut fs_setup = FarmStakingSetup::new(
        farm_staking_locked::contract_obj,
        energy_factory::contract_obj,
...
#[test]
fn farm_staking_locked_claim_boosted_rewards_for_user_test() {
    DebugApi::dummy();
    let mut fs_setup = FarmStakingSetup::new(
        farm_staking_locked::contract_obj,
        energy_factory::contract_obj,
...
#[test]
fn farm_staking_locked_full_position_boosted_rewards_test() {
    DebugApi::dummy();
    let mut fs_setup = FarmStakingSetup::new(
        farm_staking_locked::contract_obj,
        energy_factory::contract_obj,
