...
pub const SAFE_PRICE_ROUND_DURATION_SECONDS: u64 = 6;
pub const ROUND_AFTER_PAIR_SETUP: u64 = 603;
pub const TIMESTAMP_FIRST_ADD_LIQ: u64 = SAFE_PRICE_ROUND_DURATION_SECONDS;
pub const TIMESTAMP_SECOND_ADD_LIQ: u64 = 2 * SAFE_PRICE_ROUND_DURATION_SECONDS;
