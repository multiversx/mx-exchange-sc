...
pub trait Farm:
    ...
    + enter_farm_common::EnterFarmCommon
    ...
    + events::EventsModule
{
    ...
    fn enter_farm(
        ...
        self.enter_farm_common(opt_accept_funds_func, Self::mint_per_block_rewards)
    }
    ...
    fn exit_farm(
        ...
        self.generate_aggregated_rewards(&reward_token_id, Self::mint_per_block_rewards);
    ...
    fn compound_rewards(
        ...
        self.generate_aggregated_rewards(&reward_token, Self::mint_per_block_rewards);
