    ...
    + energy_query::EnergyQueryModule
{
    ...
    fn generate_aggregated_rewards_with_boosted_yields(
        &self,
    ...
    fn calculate_reward_with_boosted_yields(
        ...
        let base_farm_reward =
            self.default_calculate_reward(farm_token_amount, attributes, storage_cache);
        let boosted_yield_rewards =
            self.claim_boosted_yields_rewards(user, &storage_cache.reward_token_id);
