...
pub static ERROR_SAFE_PRICE_WEIGHT_ORDER: &[u8] =
    b"Safe price observations must have increasing cumulative weight";
pub static ERROR_SAFE_PRICE_CURRENT_INDEX: &[u8] = b"Invalid safe price current index";
...
pub static ERROR_SAFE_PRICE_TIMESTAMP_ORDER: &[u8] = b"Invalid safe price timestamp order";
