    ...
    + token_send::TokenSendModule
{
    ...
    fn increase_token_reserve(&self, token_id: &TokenIdentifier, amount: &BigUint) {
    ...
    fn decrease_token_reserve(&self, token_id: &TokenIdentifier, amount: &BigUint) {
        self.pair_reserve(token_id)
            .update(|reserve| *reserve -= amount);
    }
    ...
    fn calculate_k_for_virtual_reserves(&self, token_side_id: &TokenIdentifier) -> BigUint {
    ...
    fn last_recorded_block_nonce(&self) -> SingleValueMapper<u64>;
