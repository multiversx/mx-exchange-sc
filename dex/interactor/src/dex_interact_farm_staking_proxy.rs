...
pub trait FarmProxyTrait {
    ...
    // views
    async fn is_sc_address_whitelisted(dex_interact: &mut DexInteract, address: Address) -> bool;
    async fn get_dual_yield_token_id(dex_interact: &mut DexInteract) -> String;
    async fn get_lp_farm_address(dex_interact: &mut DexInteract) -> Address;
    async fn get_staking_farm_address(dex_interact: &mut DexInteract) -> Address;
    async fn get_pair_address(dex_interact: &mut DexInteract) -> Address;
    async fn get_staking_token_id(dex_interact: &mut DexInteract) -> String;
    async fn get_farm_token_id(dex_interact: &mut DexInteract) -> String;
    async fn get_lp_token_id(dex_interact: &mut DexInteract) -> String;
    async fn get_lp_farm_token_id(dex_interact: &mut DexInteract) -> String;
    async fn get_energy_factory_address(dex_interact: &mut DexInteract) -> Address;
}

impl FarmProxyTrait for FarmProxy {
    // views
    async fn is_sc_address_whitelisted(dex_interact: &mut DexInteract, address: Address) -> bool {
        dex_interact
            .interactor
